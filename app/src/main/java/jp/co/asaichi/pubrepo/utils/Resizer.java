...
import jp.co.asaichi.pubrepo.utils.util.ImageUtils;
...
public class Resizer {
    ...
    public File getResizedFile() throws IOException {
        return jp.co.asaichi.pubrepo.utils.util.ImageUtils.getScaledImage(targetLength, quality, compressFormat, outputDirPath, outputFilename, sourceImage);
    }
